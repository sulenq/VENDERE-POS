...
import { RequireAuth, useSignIn, useSignOut } from 'react-auth-kit';
...
export default function App() {
  ...
  //       `http://localhost:8080/api/v1/users/admin/check`
  //     );
